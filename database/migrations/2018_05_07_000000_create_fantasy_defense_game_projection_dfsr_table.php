...
use App\Models\FantasyData\FantasyDefenseGameProjectionDfsr;
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;

class CreateFantasyDefenseGameProjectionDfsrTable extends Migration
{
    public function up()
    {
        $tablename = (new FantasyDefenseGameProjectionDfsr)->getTable();
