...
class CreateLeagueScheduleSimTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('league_schedule_sims', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('league_schedule_sims');
    }
}
