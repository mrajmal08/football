...
use App\Models\FantasyData\PlayerGameProjectionDfsr;
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;

class CreatePlayerGameProjectionDfsrTable extends Migration
{
    public function up()
    {
        $tablename = (new PlayerGameProjectionDfsr)->getTable();
