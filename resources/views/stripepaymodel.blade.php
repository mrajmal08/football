 <!-- Modal -->
 <form enctype="multipart/form-data" action="{{route('stripePost')}}" method="Post" class="require-validation" data-cc-on-file="false" id="payment-form" >
            ...
            <div style="margin: 5%;" class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('stripePost') }}">Pay now</a> --}}
                            <button type="submit">Pay Now 150$</button>
                        </div>
                    </div>
