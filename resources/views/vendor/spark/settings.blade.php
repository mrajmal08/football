        ...
        <div class="spark-screen container">
            <div class="row">
                ...
                <div class="col-md-3 spark-settings-tabs">
                    <aside>
                        ...
                        <ul class="nav flex-column mb-4 ">
							@if($showLeague == 1)
							<li class="nav-item ">
								<a class="nav-link" href="#league" aria-controls="league" role="tab" data-toggle="tab">
			  ...
			  18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
							  ...
							  <li class="nav-item ">
                                <a class="nav-link" href="#league-team" aria-controls="league-team" role="tab" data-toggle="tab">
                                    <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
                                        <path d="M10 20C4.4772 20 0 15.5228 0 10S4.4772 0 10 0s10 4.4772 10 10-4.4772 10-10 10zm0-17C8.343 3 7
              4.343 7 6v2c0 1.657 1.343 3 3 3s3-1.343 3-3V6c0-1.657-1.343-3-3-3zM3.3472 14.4444C4.7822 16.5884 7.2262 18 10
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#league-waivers" aria-controls="league-waivers" role="tab" data-toggle="tab">
                                    <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
                                        <path d="M10 20C4.4772 20 0 15.5228 0 10S4.4772 0 10 0s10 4.4772 10 10-4.4772 10-10 10zm0-17C8.343 3 7
          4.343 7 6v2c0 1.657 1.343 3 3 3s3-1.343 3-3V6c0-1.657-1.343-3-3-3zM3.3472 14.4444C4.7822 16.5884 7.2262 18 10
          18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
							...
							@if (Spark::developer(Auth::user()->email))
							 <li class="nav-item ">
                                <a class="nav-link" href="#system" aria-controls="settings" role="tab" data-toggle="tab">
              ...
              6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z "
							 ...
							 <li class="nav-item ">
                                <a class="nav-link" href="#scoring" aria-controls="scoring" role="tab" data-toggle="tab">
                                   <svg class="icon-20 " xmlns="http://www.w3.org/2000/svg " viewBox="0 0 18 20 ">
                                        <path d="M3 8V6c0-3.3 2.7-6 6-6s6 2.7 6 6v2h1c1 0 2 1 2 2v8c0 1-1 2-2 2H2c-1 0-2-1-2-2v-8c0-1 1-2 2-2h1zm5
              6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z "
                                        />
              ...
              1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "/>
                    ...
                    @if (Spark::canBillCustomers())
                        <aside v-if="user.is_commissioner == true">
                            <h3 class="nav-heading ">
                                {{__('Billing')}}
                            </h3>
                            <ul class="nav flex-column mb-4 ">
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                ...
                <div class="col-md-9">
                    <div class="tab-content">
						<!-- League -->
                        <div role="tabcard" class="tab-pane active" id="league">
                            @include('spark::settings.league')
                        </div>
						
						
						
						  <div role="tabcard" class="tab-pane " id="league-team">
                            @include('spark::settings.league-team')
                        </div>

                        <div role="tabcard" class="tab-pane " id="league-waivers">
                            @include('spark::settings.league-waivers')
                        </div>
                        ...
                        <div role="tabcard" class="tab-pane" id="profile">
						 ...
						 <!-- Profile -->
                        <div role="tabcard" class="tab-pane" id="system">
                            @include('spark::settings.system')
                        </div>

						 <!-- Profile -->
                        <div role="tabcard" class="tab-pane" id="scoring">
                            @include('spark::settings.scoring-review')
                        </div>
