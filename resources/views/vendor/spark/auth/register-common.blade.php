...
<!-- Plan Selection -->
<div class="row d-flex justify-content-center" v-if="paidPlans.length > 0">
    <div class="col-lg-8">
...
<!-- Basic Profile -->
<div class="row d-flex justify-content-center">
    <div class="col-lg-8 @if (isset($league_full)) text-center @endif">
		@if (isset($league_full))
			<a href="{{route('register')}}"><button type="button" class="btn btn-primary">Create League</button></a>
		@else
			<div class="card card-default">
				<div class="card-header">
