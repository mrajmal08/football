...
/**
 * League Settings Components...
 */
require('./settings/league');
require('./settings/league/update-league-details');
require('./settings/league/update-league-team-details');
require('./settings/league/update-league-waivers');

/**
 * System Settings Components...
 */
require('./settings/system');
require('./settings/system/update-system-details');
...
require('./settings/subscription/test-subscription');
/**
