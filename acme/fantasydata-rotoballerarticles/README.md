...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/acme/fantasydata-rotoballerarticles.git"
    }
  ],
  "require": {
    "acme/fantasydata-rotoballerarticles": "*@dev"
  }
}
```
...
```php
    require_once('/path/to/acme/fantasydata-rotoballerarticles/vendor/autoload.php');
```
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**rotoballerArticles**](docs/Api/DefaultApi.md#rotoballerarticles) | **GET** /{format}/RotoBallerArticles | RotoBaller Articles
*DefaultApi* | [**rotoballerArticlesByDate**](docs/Api/DefaultApi.md#rotoballerarticlesbydate) | **GET** /{format}/RotoBallerArticlesByDate/{date} | RotoBaller Articles by Date
*DefaultApi* | [**rotoballerArticlesByPlayer**](docs/Api/DefaultApi.md#rotoballerarticlesbyplayer) | **GET** /{format}/RotoBallerArticlesByPlayerID/{playerid} | RotoBaller Articles by Player
