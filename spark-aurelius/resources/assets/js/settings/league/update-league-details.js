module.exports = {
    ...
    mounted() {
		...
		this.form.draft_pick_max_time					= this.user.draft_pick_max_time;
		this.form.override_system 				= this.user.override_system ;
		this.form.allow_team_qb 				= 1 ;
		this.form.is_co_commissioner 			= this.user.co_commissioner ;
    ...
    methods: {
		...
		startleaque() {
            ...
            Spark.post('/league/startleaque', this.form)
                .then(() => {
					 this.form.updated 							= true;
					 this.form.removed 						    = false;
                    //Bus.$emit('updateUser');
