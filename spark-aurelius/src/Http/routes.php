...
$router->group(['middleware' => 'web'], function ($router) {
	...
	$router->get('/register/final', 'Settings\DashboardController@final_show')->name('settings');
    ...
    // Registration...
    $router->get('/register/{invite_code?}', 'Auth\RegisterController@showRegistrationForm')->name('register');
    $router->get('/register/{invite_code?}/{invite_token?}', 'Auth\RegisterController@showRegistrationForm')->name('register');
    $router->post('/register', 'Auth\RegisterController@register');

	// $router->get('/register/final', 'Auth\RegisterController@showRegistrationForm')->name('register');
    // Password Reset...
