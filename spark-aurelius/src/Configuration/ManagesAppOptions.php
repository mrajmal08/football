...
trait ManagesAppOptions
{
     ...
     * @var string
     */
    public static $afterLoginRedirectTo = '/league/home';

	 public static $afterRegisterRedirectTo = '/register/final';
    ...
    public static function afterLoginRedirect()
    {
	 ...
	 public static function afterRegisterRedirect()
    {
        return value(static::$afterRegisterRedirectTo);
    }
    /**
