...
class UpdateFantasyPlayersByGameDate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'UpdateFantasyPlayersByGameDate';
    ...
    public function handle()
    {
        ...
        try {
            $result = $apiInstance->dailyFantasyPlayers('json', $date);
            if (! empty($result)) {
