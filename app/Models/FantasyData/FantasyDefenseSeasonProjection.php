...
class FantasyDefenseSeasonProjection extends Model
{
    use SoftDeletes;

    protected $table = 'fantasy_defense_season_projection';
    ...
    // protected $with = ['FantasyPlayerSeasonProjectionFantasyPoint'];

    // public function FantasyPlayerSeasonProjectionFantasyPoint()
    // {
    //     return $this->hasManyThrough('App\Models\FantasyPlayerProjectedSeasonFantasyPoint', 'App\Models\FantasyData\FantasyPlayer', 'fantasy_player_key', 'fantasy_player_id', 'team', 'id');
    ...
    // {
    //     $fantasy_points_acme=($this->FantasyPlayerSeasonProjectionFantasyPoint)?$this->FantasyPlayerSeasonProjectionFantasyPoint
