...
class FantasyDefenseGame extends Model
{
    use SoftDeletes;

    protected $table = 'fantasy_defense_game';
    ...
    // {
    //     return $this->hasManyThrough('App\Models\FantasyPlayerGameFantasyPoint', 'App\Models\FantasyData\FantasyPlayer', 'fantasy_player_key', 'fantasy_player_id', 'team', 'id');
