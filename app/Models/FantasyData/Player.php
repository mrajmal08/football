...
class Player extends Model
{
    ...
    /**
     * Get the fantasy player.
     */
    public function fantasyPlayer()
    {
        return $this->belongsTo(\App\Models\FantasyData\FantasyPlayer::class, 'player_id', 'player_id');
    }

    public function PlayerTeam()
    {
        return $this->hasOne(\App\Models\FantasyData\Team::class, 'team_id', 'team_id');
    }
}
