...
class PlayerGameProjection extends Model
{
    use SoftDeletes;
    use UserTimezoneAware;

    protected $table = 'player_game_projection';
    ...
    // {
    //     return $this->hasManyThrough('App\Models\FantasyPlayerProjectedGameFantasyPoint', 'App\Models\FantasyData\FantasyPlayer', 'player_id', 'fantasy_player_id', 'player_id', 'id');
    // }
    ...
    public function getFormatedGameDateAttribute($value)
    {
        $createdAt = Carbon::parse($this->getDateToUserTimezone($this->attributes['game_date']));

        return $createdAt = $createdAt->format('m/d');
    }
}
