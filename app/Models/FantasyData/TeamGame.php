...
class TeamGame extends Model
{
    ...
    protected $casts = [
        ...
        'opponent_time_of_possession_minutes' => 'integer',
        'opponent_time_of_possession_seconds' => 'integer',
    ...
    //TODO: Add support to easy return score for current game filter
    ...
    {
        return $this->belongsTo('App\Models\FantasyPlayer')->withDefault();
    }
}
