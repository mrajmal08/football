...
class PlayerSeasonProjection extends Model
{
    use SoftDeletes;

    protected $table = 'player_season_projection';
    ...
    // {
    //     return $this->hasManyThrough('App\Models\FantasyPlayerProjectedSeasonFantasyPoint', 'App\Models\FantasyData\FantasyPlayer', 'player_id', 'fantasy_player_id', 'player_id', 'id');
    // }
